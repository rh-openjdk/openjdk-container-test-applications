**this a copy of https://github.com/quarkusio/quarkus-quickstarts.git
getting-started, from branch 3.0.3.Final, with one modification:

 * getting-started/.s2i has been removed**
